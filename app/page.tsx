    ...
    <main>
      ...
      <section className="hero" id="inicio">
        ...
        <div className="hero-copy">
          ...
          <h1 className="reveal">7 transações.<br /><span>Um ciclo até<br />12.500 €</span></h1>
        ...
        <div className="hero-product reveal">
          ...
          <div className="live-card"><span /><div><small>SISTEMA ATIVO</small><b>A IA está a negociar</b></div><Cpu size={18} /></div>
      ...
      <section className="how" id="como">
        ...
        <div className="trust-strip reveal"><span><LockKeyhole /> Lucro 100% automatizado</span><span><Cpu /> IA negoceia por si</span><span><Check /> 7 transações por ciclo</span><span><LineChart /> Levantamento garantido</span></div>
      </section>
      ...
      <section className="results" id="resultados">
        ...
        <article className="video-story reveal">
          ...
          <div><span>DEPOIMENTO EM VÍDEO · 00:31</span><h3>Inês mostra a sua experiência</h3><p>A Inês juntou-se recentemente ao projeto e partilhou em vídeo os seus primeiros resultados, com €6.356 gerados na plataforma no piloto automático.</p></div>
        </article>
      ...
      <section className="assurance" id="seguranca">
        <div className="assurance-head reveal"><span>GARANTIAS E FIABILIDADE</span><h2>Proteção total para<br /><em>os seus lucros.</em></h2><p>A AutoLucro IA opera de forma legal e transparente, garantindo total segurança apoiada pelas licenças MiCA e um fundo de proteção robusto.</p></div>
      ...
      <section className="faq" id="faq">
        <div className="faq-copy reveal"><span>PERGUNTAS FREQUENTES</span><h2>O essencial.<br /><em>Direto ao ponto.</em></h2><p>As respostas mais importantes sobre o funcionamento da IA, garantias e levantamentos do sistema.</p></div>
